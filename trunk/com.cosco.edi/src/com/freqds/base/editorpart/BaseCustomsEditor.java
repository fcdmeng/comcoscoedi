...
public class BaseCustomsEditor extends EditorPartAdapter {

	public static final String ID = "com.freqds.base.editorpart.BaseCustomsEditor"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		BaseCustomsEditorActionGroup actionGroup = new BaseCustomsEditorActionGroup(tv);
...
//		actionGroup.fireFirstAction();
	...
	private void createTableViewer(ViewForm parent) {
		...
		new TableColumn(table, SWT.NONE).setText("海关关区代码");
		
		layout.addColumnData(new ColumnWeightData(30));
		new TableColumn(table, SWT.NONE).setText("名称");
		
		layout.addColumnData(new ColumnWeightData(7));
		new TableColumn(table, SWT.NONE).setText("ABBR_CUST");
