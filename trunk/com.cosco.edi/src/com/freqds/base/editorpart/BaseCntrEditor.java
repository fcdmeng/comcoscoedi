...
public class BaseCntrEditor extends EditorPartAdapter {

	public static final String ID = "com.freqds.base.editorpart.BaseCntrEditor"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		BaseCntrEditorActionGroup actionGroup = new BaseCntrEditorActionGroup(tv);
	...
	private void createTableViewer(ViewForm parent) {
		...
		new TableColumn(table, SWT.NONE).setText("箱型代码");
