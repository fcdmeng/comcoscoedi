...
public class BaseLineEditor extends EditorPartAdapter {

	public static final String ID = "com.freqds.base.editorpart.BaseLineEditor"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		BaseLineEditorActionGroup actionGroup = new BaseLineEditorActionGroup(tv);
