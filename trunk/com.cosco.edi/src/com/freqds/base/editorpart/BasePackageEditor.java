...
public class BasePackageEditor extends EditorPartAdapter {

	public static final String ID = "com.freqds.base.editorpart.BasePackageEditor"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		BasePackageEditorActionGroup actionGroup = new BasePackageEditorActionGroup(tv);
...
//		actionGroup.fireFirstAction();
	...
	private void createTableViewer(ViewForm parent) {
		...
		new TableColumn(table, SWT.NONE).setText("包装代码");
